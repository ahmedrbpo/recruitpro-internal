...
namespace RecruitPro.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260713045221_UpdateJobAddClientAndJobCategory")]
    partial class UpdateJobAddClientAndJobCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RecruitPro.Domain.Recruitment.Entities.Client", b =>
                {
                    ...
                    b.Property<bool>("IsPreferredClient")
                        .HasColumnType("boolean")
                        .HasColumnName("is_preferred_client");
                    ...
                    b.HasIndex("ClientStatus")
                        .HasDatabaseName("ix_clients_client_status")
                        .HasFilter("is_deleted = false");
            ...
            modelBuilder.Entity("RecruitPro.Domain.Recruitment.Entities.Job", b =>
                {
                    ...
                    b.HasOne("RecruitPro.Domain.Identity.Entities.ApplicationUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_jobs_users_recruiter_id");
                });
