...
/// <summary>Builds a one-off AuthorizationPolicy per permission string on demand, so a new
/// [RequirePermission("X.Y.Z")] never needs a matching AddPolicy registration in Program.cs.</summary>
